...
<html lang="ar" dir="rtl">
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('front') }}/assets/css/rangeSlider.min.css">
    ...
    <body>
                            ...
                            <li>
                                <div class="dropdown language-switcher d-inline-block">
                                    <button class="dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <img src="{{ asset('front') }}/assets/img/us-flag.jpg" alt="image">
                                        <span>Eng <i class='bx bx-chevron-down'></i></span>
                                    </button>

                                    <div class="dropdown-menu">
                                        <a href="#" class="dropdown-item d-flex align-items-center">
                                            <img src="{{ asset('front') }}/assets/img/germany-flag.jpg" class="shadow-sm" alt="flag">
                                            <span>Ger</span>
                                        </a>
                                        <a href="#" class="dropdown-item d-flex align-items-center">
                                            <img src="{{ asset('front') }}/assets/img/france-flag.jpg" class="shadow-sm" alt="flag">
                                            <span>Fre</span>
                                        </a>
                                        <a href="#" class="dropdown-item d-flex align-items-center">
                                            <img src="{{ asset('front') }}/assets/img/spain-flag.jpg" class="shadow-sm" alt="flag">
                                            <span>Spa</span>
                                        </a>
                                        <a href="#" class="dropdown-item d-flex align-items-center">
                                            <img src="{{ asset('front') }}/assets/img/russia-flag.jpg" class="shadow-sm" alt="flag">
                                            <span>Rus</span>
                                        </a>
                                        <a href="#" class="dropdown-item d-flex align-items-center">
                                            <img src="{{ asset('front') }}/assets/img/italy-flag.jpg" class="shadow-sm" alt="flag">
                                            <span>Ita</span>
                                        </a>
                                    </div>
                                </div>
            ...
            <div class="xton-responsive-nav">
                <div class="container">
                    <div class="xton-responsive-menu">
                        <div class="logo">
                            <a href="index.html">
                                <img src="{{ asset('front') }}/assets/img/logo.png" class="main-logo" alt="logo">
                                <img src="{{ asset('front') }}/assets/img/white-logo.png" class="white-logo" alt="logo">
                            </a>
                        </div>
                    </div>
                </div>
                                            ...
                                            <div class="container">
                                                <div class="row">
                                                    ...
                                                    <div class="col">
                                                        ...
                                                        <ul class="megamenu-submenu">
                                                            <li><a href="products-type-1.html" class="active">Default Style</a></li>
                                                ...
                                                <div class="brand-slides owl-carousel owl-theme">
                                                    <div class="brand-item">
                                                        <a href="#"><img src="{{ asset('front') }}/assets/img/brand/img1.png" alt="image"></a>
                                                    </div>
                                
                                                    <div class="brand-item">
                                                        <a href="#"><img src="{{ asset('front') }}/assets/img/brand/img2.png" alt="image"></a>
                                                    </div>
                                
                                                    <div class="brand-item">
                                                        <a href="#"><img src="{{ asset('front') }}/assets/img/brand/img3.png" alt="image"></a>
                                                    </div>
                                
                                                    <div class="brand-item">
                                                        <a href="#"><img src="{{ asset('front') }}/assets/img/brand/img4.png" alt="image"></a>
                                                    </div>
                                
                                                    <div class="brand-item">
                                                        <a href="#"><img src="{{ asset('front') }}/assets/img/brand/img5.png" alt="image"></a>
                                                    </div>
                                
                                                    <div class="brand-item">
                                                        <a href="#"><img src="{{ asset('front') }}/assets/img/brand/img6.png" alt="image"></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </li>
                                                        ...
                                                        <ul class="megamenu-submenu">
                                                            <li>
                                                                <div class="aside-trending-products">
                                                                    <img src="{{ asset('front') }}/assets/img/categories/img1.jpg" alt="image">
                                                                ...
                                                                <div class="aside-trending-products">
                                                                    <img src="{{ asset('front') }}/assets/img/categories/img2.jpg" alt="image">
                    ...
                    <div class="col-lg-5 col-md-12">
                        <div class="products-details-image">
                            <ul class="products-details-image-slides">
                                <li><img src="{{ asset('front') }}/assets/img/products/img3.jpg" alt="image"></li>
                                <li><img src="{{ asset('front') }}/assets/img/products/img4.jpg" alt="image"></li>
                                <li><img src="{{ asset('front') }}/assets/img/products/img-hover3.jpg" alt="image"></li>
                                <li><img src="{{ asset('front') }}/assets/img/products/img-hover4.jpg" alt="image"></li>
                                <li><img src="{{ asset('front') }}/assets/img/products/img7.jpg" alt="image"></li>
                            </ul>
                    ...
                    <div class="products-slides owl-carousel owl-theme">
                        <div class="single-products-box">
                            <div class="products-image">
                                <a href="#">
                                    <img src="{{ asset('front') }}/assets/img/products/img1.jpg" class="main-image" alt="image">
                                    <img src="{{ asset('front') }}/assets/img/products/img-hover1.jpg" class="hover-image" alt="image">
                                </a>
                        ...
                        <div class="single-products-box">
                            <div class="products-image">
                                <a href="#">
                                    <img src="{{ asset('front') }}/assets/img/products/img2.jpg" class="main-image" alt="image">
                                    <img src="{{ asset('front') }}/assets/img/products/img-hover2.jpg" class="hover-image" alt="image">
                                </a>
                        ...
                        <div class="single-products-box">
                            <div class="products-image">
                                <a href="#">
                                    <img src="{{ asset('front') }}/assets/img/products/img3.jpg" class="main-image" alt="image">
                                    <img src="{{ asset('front') }}/assets/img/products/img-hover3.jpg" class="hover-image" alt="image">
                                </a>
                        ...
                        <div class="single-products-box">
                            <div class="products-image">
                                <a href="#">
                                    <img src="{{ asset('front') }}/assets/img/products/img4.jpg" class="main-image" alt="image">
                                    <img src="{{ asset('front') }}/assets/img/products/img-hover4.jpg" class="hover-image" alt="image">
                                </a>
                        ...
                        <div class="single-products-box">
                            <div class="products-image">
                                <a href="#">
                                    <img src="{{ asset('front') }}/assets/img/products/img5.jpg" class="main-image" alt="image">
                                    <img src="{{ asset('front') }}/assets/img/products/img-hover5.jpg" class="hover-image" alt="image">
                                </a>
                        ...
                        <div class="single-products-box">
                            <div class="products-image">
                                <a href="#">
                                    <img src="{{ asset('front') }}/assets/img/products/img6.jpg" class="main-image" alt="image">
                                    <img src="{{ asset('front') }}/assets/img/products/img-hover6.jpg" class="hover-image" alt="image">
                                </a>
            ...
            <div class="container-fluid">
                ...
                <div class="instagram-slides owl-carousel owl-theme">
                    <div class="single-instagram-post">
                        <img src="{{ asset('front') }}/assets/img/instagram/img1.jpg" alt="image">
                        <i class='bx bxl-instagram'></i>
                        <a href="#" target="_blank" class="link-btn"></a>
                    </div>

                    <div class="single-instagram-post">
                        <img src="{{ asset('front') }}/assets/img/instagram/img2.jpg" alt="image">
                        <i class='bx bxl-instagram'></i>
                        <a href="#" target="_blank" class="link-btn"></a>
                    </div>

                    <div class="single-instagram-post">
                        <img src="{{ asset('front') }}/assets/img/instagram/img3.jpg" alt="image">
                        <i class='bx bxl-instagram'></i>
                        <a href="#" target="_blank" class="link-btn"></a>
                    </div>
                    
                    <div class="single-instagram-post">
                        <img src="{{ asset('front') }}/assets/img/instagram/img4.jpg" alt="image">
                        <i class='bx bxl-instagram'></i>
                        <a href="#" target="_blank" class="link-btn"></a>
                    </div>
                    
                    <div class="single-instagram-post">
                        <img src="{{ asset('front') }}/assets/img/instagram/img10.jpg" alt="image">
                        <i class='bx bxl-instagram'></i>
                        <a href="#" target="_blank" class="link-btn"></a>
                    </div>
                    
                    <div class="single-instagram-post">
                        <img src="{{ asset('front') }}/assets/img/instagram/img6.jpg" alt="image">
                        <i class='bx bxl-instagram'></i>
                        <a href="#" target="_blank" class="link-btn"></a>
                    </div>
                    
                    <div class="single-instagram-post">
                        <img src="{{ asset('front') }}/assets/img/instagram/img7.jpg" alt="image">
                        <i class='bx bxl-instagram'></i>
                        <a href="#" target="_blank" class="link-btn"></a>
                    </div>
                    
                    <div class="single-instagram-post">
                        <img src="{{ asset('front') }}/assets/img/instagram/img8.jpg" alt="image">
                        <i class='bx bxl-instagram'></i>
                        <a href="#" target="_blank" class="link-btn"></a>
                    </div>
                    
                    <div class="single-instagram-post">
                        <img src="{{ asset('front') }}/assets/img/instagram/img9.jpg" alt="image">
                        <i class='bx bxl-instagram'></i>
                        <a href="#" target="_blank" class="link-btn"></a>
                    </div>
                    
                    <div class="single-instagram-post">
                        <img src="{{ asset('front') }}/assets/img/instagram/img5.jpg" alt="image">
                        <i class='bx bxl-instagram'></i>
                        <a href="#" target="_blank" class="link-btn"></a>
                    </div>
                </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="sidebar-new-in-store">
                            ...
                            <ul class="products-list">
                                <li>
                                    <a href="#"><img src="{{ asset('front') }}/assets/img/products/img1.jpg" alt="image"></a>
                                </li>

                                <li>
                                    <a href="#"><img src="{{ asset('front') }}/assets/img/products/img2.jpg" alt="image"></a>
                                </li>

                                <li>
                                    <a href="#"><img src="{{ asset('front') }}/assets/img/products/img3.jpg" alt="image"></a>
                                </li>

                                <li>
                                    <a href="#"><img src="{{ asset('front') }}/assets/img/products/img4.jpg" alt="image"></a>
                                </li>
                            </ul>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6 col-md-6">
                            <div class="products-image">
                                <img src="{{ asset('front') }}/assets/img/quick-view-img.jpg" alt="image">
                            </div>
                        </div>
                    ...
                    <div class="modal-body">
                        <div class="woocommerce-widget-area">
                            ...
                            <div class="woocommerce-widget aside-trending-widget">
                                <div class="aside-trending-products">
                                    <img src="{{ asset('front') }}/assets/img/offer-bg.jpg" alt="image">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <ul class="payment-types">
                                <li><a href="#" target="_blank"><img src="{{ asset('front') }}/assets/img/payment/visa.png" alt="image"></a></li>
                                <li><a href="#" target="_blank"><img src="{{ asset('front') }}/assets/img/payment/mastercard.png" alt="image"></a></li>
                                <li><a href="#" target="_blank"><img src="{{ asset('front') }}/assets/img/payment/mastercard2.png" alt="image"></a></li>
                                <li><a href="#" target="_blank"><img src="{{ asset('front') }}/assets/img/payment/visa2.png" alt="image"></a></li>
                                <li><a href="#" target="_blank"><img src="{{ asset('front') }}/assets/img/payment/expresscard.png" alt="image"></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <script src="{{ asset('front') }}/assets/js/sticky-sidebar.min.js"></script>
