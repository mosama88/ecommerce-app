...
<aside class="app-sidebar sidebar-scroll">
    <div class="main-sidebar-header active">
        <a class="desktop-logo logo-light active" href="{{ url('/') }}"><img
                src="{{ URL::asset('dashboard/assets/img/brand/logo.png') }}" class="main-logo" alt="logo"></a>
        <a class="desktop-logo logo-dark active" href="{{ url('/') }}"><img
                src="{{ URL::asset('dashboard/assets/img/brand/logo-white.png') }}" class="main-logo dark-theme"
                alt="logo"></a>
        <a class="logo-icon mobile-logo icon-light active" href="{{ url('/') }}"><img
                src="{{ URL::asset('dashboard/assets/img/brand/favicon.png') }}" class="logo-icon" alt="logo"></a>
        <a class="logo-icon mobile-logo icon-dark active" href="{{ url('/') }}"><img
                src="{{ URL::asset('dashboard/assets/img/brand/favicon-white.png') }}" class="logo-icon dark-theme"
                alt="logo"></a>
    </div>
    <div class="main-sidemenu">
            ...
            <div class="dropdown user-pro-body">
                <div class="">
                    <img alt="user-img" class="avatar avatar-xl brround"
                        src="{{ URL::asset('dashboard/assets/img/login-user.png') }}"><span
        ...
        <ul class="side-menu">
            <li class="side-item text-center side-item-category ">برنامج إدارة الموارد البشرية </li>
            <li class="side-item text-center side-item-category mt-2">{{ $data['company_name'] }}</li>
            <li class="slide">
                <a class="side-menu__item" href="{{ url('/') }}"><svg xmlns="http://www.w3.org/2000/svg"
                    ...
                    </svg><span class="side-menu__label">لوحة التحكم</span><span
                ...
                <li
                    ...
                    <a class="side-menu__item {{ request()->is('generalSettings*') || request()->is('financeCalendars*') ? 'active' : '' }}"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                            ...
                            <path
                                d="M19.14,12.94c0.04-0.3,0.06-0.61,0.06-0.94s-0.02-0.64-0.06-0.94l2.03-1.58c0.18-0.14,0.23-0.39,0.12-0.6l-1.92-3.32 c-0.11-0.2-0.35-0.28-0.57-0.22l-2.39,0.96c-0.5-0.38-1.05-0.69-1.66-0.9L14.5,2.8C14.48,2.58,14.28,2.42,14.06,2.42h-4.12 c-0.22,0-0.42,0.16-0.44,0.38L9,6.4c-0.61,0.22-1.17,0.52-1.66,0.9L4.95,6.34c-0.22-0.08-0.46,0.02-0.57,0.22l-1.92,3.32 c-0.11,0.2-0.06,0.45,0.12,0.6l2.03,1.58C4.86,11.36,4.84,11.67,4.84,12s0.02,0.64,0.06,0.94l-2.03,1.58 c-0.18,0.14-0.23,0.39-0.12,0.6l1.92,3.32c0.11,0.2,0.35,0.28,0.57,0.22l2.39-0.96c0.5,0.38,1.05,0.69,1.66,0.9l0.5,3.19 c0.02,0.22,0.22,0.38,0.44,0.38h4.12c0.22,0,0.42-0.16,0.44-0.38l0.5-3.19c0.61-0.22,1.17-0.52,1.66-0.9l2.39,0.96 c0.22,0.08,0.46-0.02,0.57-0.22l1.92-3.32c0.11-0.2,0.06-0.45-0.12-0.6L19.14,12.94z M12,15.5c-1.93,0-3.5-1.57-3.5-3.5 s1.57-3.5,3.5-3.5s3.5,1.57,3.5,3.5S13.93,15.5,12,15.5z" />
                        </svg>
                        <span class="side-menu__label">الأعدادات</span><i class="angle fe fe-chevron-down"></i></a>
                    <ul class="slide-menu">
                        @can('الضبط العام')
                            <li><a class="slide-item {{ request()->is('generalSettings*') ? 'active' : '' }}"
                                    href="{{ route('dashboard.generalSettings.index') }}">الضبط العام</a></li>
                        @endcan

                        @can('السنوات المالية')
                            <li><a class="slide-item {{ request()->is('financeCalendars*') ? 'active' : '' }}"
                                    href="{{ route('dashboard.financeCalendars.index') }}">السنوات المالية</a></li>
                        @endcan
                        @can('الفروع')
                            <li><a class="slide-item" href="{{ route('dashboard.branches.index') }}">الفروع
                                </a>
                            </li>
                        @endcan
                        @can('الشفتات')
                            <li><a class="slide-item" href="{{ route('dashboard.shiftsTypes.index') }}">أنواع الشفتات
                                </a>
                            </li>
                        @endcan
                        @can('الأدارات')
                            <li><a class="slide-item" href="{{ route('dashboard.departments.index') }}">إدارات الموظفين
                                </a>
                            </li>
                        @endcan
                        @can('الوظائف')
                            <li><a class="slide-item" href="{{ route('dashboard.jobsCategories.index') }}">أنواع الوظائف
                                </a>
                            </li>
                        @endcan
                        @can('الدرجات الوظيفية')
                            <li><a class="slide-item" href="{{ route('dashboard.jobGrades.index') }}">الدرجات الوظيفية
                                </a>
                            </li>
                        @endcan
                        @can('المؤهل')
                            <li><a class="slide-item" href="{{ route('dashboard.qualifications.index') }}">مؤهلات الموظفين
                                </a>
                            </li>
                        @endcan
                        @can('العطلات الرسمية')
                            <li><a class="slide-item" href="{{ route('dashboard.holidays.index') }}">العطلات الرسمية
                                </a>
                            </li>
                        @endcan
                        @can('الأستقالة')
                            <li><a class="slide-item" href="{{ route('dashboard.resignations.index') }}">أنواع الاستقالة
                                </a>
                            </li>
                        @endcan
                        @can('الأجازات')
                        ...
                        @endcan
                        @can('البلاد')
                            <li><a class="slide-item" href="{{ route('dashboard.countries.index') }}">البلاد
                                </a>
                            </li>
                        @endcan
                        @can('المنطقه')
                        ...
                        @endcan
                        @can('الجنسيات')
                            <li><a class="slide-item" href="{{ route('dashboard.nationalities.index') }}">الجنسيات
                                </a>
                            </li>
                        @endcan
                        @can('فصيلة الدم')
                            <li><a class="slide-item" href="{{ route('dashboard.bloodTypes.index') }}">فصيلة الدم
                                </a>
                            </li>
                        @endcan
                    </ul>
            ...
            @can('قائمة بيانات شئون الموظفين')
                <li class="side-item side-item-category">قائمة بيانات شئون الموظفين</li>
                <li class="slide {{ request()->is('employees*') ? 'menu-open' : '' }}"> <a
                        class="side-menu__item {{ request()->is('employees*') ? 'active' : '' }}" data-toggle="slide"
                        href="{{ url('/' . ($page = '#')) }}"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64"
                            class="side-menu__icon" width="24" height="24">
                            <circle cx="16" cy="18" r="8" fill="#7f8c8d" />
                            <circle cx="48" cy="18" r="8" fill="#7f8c8d" />
                            <path
                                d="M16 28c-7 0-12 5-12 12v8h24v-8c0-7-5-12-12-12zm32 0c-7 0-12 5-12 12v8h24v-8c0-7-5-12-12-12zm-16 0c-7 0-12 5-12 12v8h24v-8c0-7-5-12-12-12z"
                                fill="#2c3e50" />
                        </svg><span class="side-menu__label">شئون الموظفين</span><i
                            class="angle fe fe-chevron-down"></i></a>
                    <ul class="slide-menu">
                        @can('بيانات الموظفين')
                            <li><a class="slide-item {{ request()->is('employees*') ? 'active' : '' }}"
                                    href="{{ route('dashboard.employees.index') }}">بيانات الموظفين</a>
                            </li>
                        @endcan
                        @can('الأضافى للراتب')
                            <li><a class="slide-item" href="{{ route('dashboard.additional_types.index') }}">أنواع الأضافى
                                    للراتب</a></li>
                        @endcan
                        @can('الخصم')
                            <li><a class="slide-item" href="{{ route('dashboard.discount_types.index') }}">أنواع الخصم
                                    للراتب</a>
                            </li>
                        @endcan
                        @can('البدلات')
                            <li><a class="slide-item" href="{{ route('dashboard.allowances.index') }}">أنواع البدلات
                                    للراتب</a>
                            </li>
                        @endcan
                    </ul>
            ...
            @can('قائمة الأجور')
                <li class="side-item side-item-category">قائمة الأجور</li>
                <li
                    class="slide {{ request()->is('sanctions*') || request()->is('absences*') || request()->is('additionals*') || request()->is('discounts*') || request()->is('rewards*') || request()->is('allowancesSalary*') || request()->is('loans*') || request()->is('mainSalaryEmployees*') ? 'menu-open' : '' }}">
                    <a class="side-menu__item {{ request()->is('sanctions*') || request()->is('absences*') || request()->is('additionals*') || request()->is('discounts*') || request()->is('rewards*') || request()->is('allowancesSalary*') || request()->is('loans*') || request()->is('mainSalaryEmployees*') ? 'active' : '' }}"
                        data-toggle="slide" href="{{ url('/' . ($page = '#')) }}">
                        <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                            <path fill="none" d="M0 0h24v24H0z" />
                            <path d="M21 9V7H3v2h18zM3 17v2h18v-2H3zm0-4h18v-2H3v2z" />
                            <path d="M10 12H6v2h4v2l3-3-3-3v2z" />
                        </svg>

                        <span class="side-menu__label">قائمة الأجور</span><i class="angle fe fe-chevron-down"></i></a>
                    <ul class="slide-menu">
                        @can('السجلات الرئيسية للرواتب')
                            <li><a class="slide-item" href="{{ route('dashboard.salaryRecords.index') }}">السجلات الرئيسية
                                    للراواتب</a></li>
                        @endcan
                        @can('الجزاءات')
                            <li><a class="slide-item {{ request()->is('sanctions*') ? 'active' : '' }}"
                                    href="{{ route('dashboard.sanctions.index') }}">جزاء
                                    أيام</a></li>
                        @endcan
                        @can('الغيابات')
                            <li><a class="slide-item {{ request()->is('absences*') ? 'active' : '' }}"
                                    href="{{ route('dashboard.absences.index') }}">غياب
                                    أيام</a></li>
                        @endcan
                        @can('الأضافى')
                            <li><a class="slide-item {{ request()->is('additionals*') ? 'active' : '' }}"
                                    href="{{ route('dashboard.additionals.index') }}">أضافى أيام</a></li>
                        @endcan
                        @can('الخصومات')
                            <li><a class="slide-item {{ request()->is('discounts*') ? 'active' : '' }}"
                                    href="{{ route('dashboard.discounts.index') }}">الخصومات
                                    المالية</a></li>
                        @endcan
                        @can('المكافئات')
                            <li><a class="slide-item {{ request()->is('rewards*') ? 'active' : '' }}"
                                    href="{{ route('dashboard.rewards.index') }}">المكافأت
                                    المالية</a></li>
                        @endcan
                        @can('البدلات المتغيرة')
                            <li><a class="slide-item {{ request()->is('allowancesSalary*') ? 'active' : '' }}"
                                    href="{{ route('dashboard.allowancesSalary.index') }}">البدلات
                                    المتغيره</a>
                            </li>
                        @endcan
                        @can('السلف الشهرية')
                            <li><a class="slide-item {{ request()->is('loans*') ? 'active' : '' }}"
                                    href="{{ route('dashboard.loans.index') }}">السلف
                                    الشهرية</a> </li>
                        @endcan
                        @can('السلف المستديمة')
                            <li><a class="slide-item {{ request()->is('permanentLoan*') ? 'active' : '' }}"
                                    href="{{ route('dashboard.permanentLoan.index') }}">السلف المستديمة</a>
                            </li>
                        @endcan
                        @can('رواتب الموظفين')
                            <li><a class="slide-item {{ request()->is('mainSalaryEmployees*') ? 'active' : '' }}"
                                    href="{{ route('dashboard.mainSalaryEmployees.index') }}">رواتب الموظفين المفصلة</a></li>
                        @endcan
                    </ul>
                </li>
            @endcan

            @can('قائمة سجلات بصمة الموظفين')
                <li class="side-item side-item-category">قائمة جهاز البصمة</li>
                <li class="slide {{ request()->is('attendanceDepartures*') ? 'menu-open' : '' }}">
                    <a class="side-menu__item {{ request()->is('attendanceDepartures*') ? 'active' : '' }}"
                        data-toggle="slide" href="{{ url('/' . ($page = '#')) }}">
                        <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                    ...
                    <ul class="slide-menu">
                        @can('سجلات بصمة الموظفين')
                            <li><a class="slide-item {{ request()->is('attendanceDepartures*') ? 'active' : '' }}"
                                    href="{{ route('dashboard.attendanceDepartures.index') }}"> بصمة
                                    الموظفين</a>
                            </li>
                        @endcan
                    </ul>
            ...
            @can('المستخدمين')
                ...
                <li
                    class="slide {{ request()->is('users*') || request()->is('roles*') || request()->is('permissions*') ? 'menu-open' : '' }}">
                    <a class="side-menu__item {{ request()->is('users*') || request()->is('roles*') || request()->is('permissions*') ? 'active' : '' }}"
                        data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                    ...
                    <ul class="slide-menu">
                        ...
                        @endcan
                        @can('الصلاحيات')
                            <li><a class="slide-item" href="{{ route('dashboard.roles.index') }}"> الصلاحيات</a>
                            </li>
                        @endcan
                        @can('الأذونات')
                            <li><a class="slide-item" href="{{ route('dashboard.permissions.index') }}"> الأذونات</a>
                            </li>
                        @endcan
                    </ul>
                </li>
