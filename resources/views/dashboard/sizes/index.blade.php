...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">المقاسات</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/
                    جدول المقاسات</span>
            </div>
        </div>
        <div class="d-flex my-xl-auto right-content">
            <div class="mb-3 mb-xl-0">
                <a class="modal-effect btn btn-primary btn-block" data-effect="effect-scale" data-toggle="modal"
                    href="#modaldemo8">أضافة مقاس جديد</a>
                @include('dashboard.sizes.create')
            ...
            <div class="card">
                <div class="card-header pb-0">
                    ...
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mg-b-0">جدول المقاسات</h4>
                                ...
                                <tbody>
                                    @foreach ($data as $info)
                                        ...
                                        <tr>
                                            ...
                                            @include('dashboard.sizes.edit')
                                            @include('dashboard.sizes.delete')
                                        </tr>
                                    @endforeach
