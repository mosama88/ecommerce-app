...
<head>
    ...
    <!-- Font Ar  font-family: DroidKufi-Regular;  -->
    <link rel="stylesheet" type="text/css" href="{{ asset('dashboard') }}/assets/fonts_ar/stylesheet.css">
                        ...
                        <li class="onhover-dropdown">
                            <div class="media align-items-center">
                                <img class="align-self-center pull-right img-50 blur-up lazyloaded"
                                    src="{{ asset('dashboard') }}/assets/images/dashboard/user3.jpg"
                                    alt="header-user">
            ...
            <div class="page-sidebar">
                    ...
                    <div class="logo-wrapper">
                        <a href="index.html">
                            <img class="d-none d-lg-block blur-up lazyloaded"
                                src="{{ asset('dashboard') }}/assets/images/dashboard/multikart-logo.png"
                                alt="">
                        </a>
                    </div>
                </div>
                <div class="sidebar custom-scrollbar">
                    ...
                    <div class="sidebar-user">
                        <img class="img-60" src="{{ asset('dashboard') }}/assets/images/dashboard/user3.jpg"
                            alt="#">
                        <div>
                                ...
                                <ul class="list">
                                    <li class="clearfix">
                                        <img class="rounded-circle user-image blur-up lazyloaded"
                                            src="{{ asset('dashboard') }}/assets/images/dashboard/user.jpg"
                                            alt="">
                                    ...
                                    <li class="clearfix">
                                        <img class="rounded-circle user-image blur-up lazyloaded"
                                            src="{{ asset('dashboard') }}/assets/images/dashboard/user1.jpg"
                                            alt="">
                                    ...
                                    <li class="clearfix">
                                        <img class="rounded-circle user-image blur-up lazyloaded"
                                            src="{{ asset('dashboard') }}/assets/images/dashboard/user2.jpg"
                                            alt="">
                                        <div class="status-circle online"></div>
                                        <div class="about">
                                    ...
                                    <li class="clearfix">
                                        <img class="rounded-circle user-image blur-up lazyloaded"
                                            src="{{ asset('dashboard') }}/assets/images/dashboard/user5.jpg"
                                            alt="">
                                        <div class="status-circle away"></div>
                                        <div class="about">
                                    ...
                                    <li class="clearfix">
                                        <img class="rounded-circle user-image blur-up lazyloaded"
                                            src="{{ asset('dashboard') }}/assets/images/dashboard/designer.jpg"
                                            alt="">
                                        <div class="status-circle online"></div>
                                        <div class="about">
