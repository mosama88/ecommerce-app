...
<div><img alt="Responsive image" class="img-fluid" src="{{URL::asset('dashboard/assets/img/photos/1.jpg')}}"></div></script></code></pre>
    ...
    <div class="card mg-b-20" id="image2">
        <div class="card-body">
            ...
            <figure class="highlight clip-widget mb-0" id="image02">
                <pre><code class="language-markup"><script type="html-dashlead/script">
<img alt="Responsive image" class="img-thumbnail wd-100p wd-sm-200" src="{{URL::asset('dashboard/assets/img/photos/1.jpg')}}"></script></code></pre>
	...
	<img alt="" class="rounded float-sm-left wd-100p wd-sm-200" src="{{URL::asset('dashboard/assets/img/photos/1.jpg')}}">
	<img alt="" class="rounded float-sm-right wd-100p wd-sm-200 mg-t-10 mg-sm-t-0" src="{{URL::asset('dashboard/assets/img/photos/1.jpg')}}">
</div>
</script></code></pre>
	...
	<img alt="Responsive image" class="img-fit-cover" src="{{URL::asset('dashboard/assets/img/photos/1.jpg')}}">
	<figcaption class="pos-absolute a-0 pd-25 bg-black-5 tx-white-8">
