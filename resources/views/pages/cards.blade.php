...
@section('content')
        ...
        <div class="col-md-4 col-lg-4 mg-md-t-0">
            <div class="card">
                <div class="card-body ">
                    ...
                    src="{{ URL::asset('dashboard/assets/img/photos/11.jpg') }}">
            </div>
        </div><!-- col-4 -->
    </div>
    <!-- /row closed -->
    ...
    <div class="row row-sm">
        <div class="col-lg-4 col-md-12 col-12 col-sm-12">
            <div class="card">
                <img class="card-img-top" src="{{ URL::asset('dashboard/assets/img/photos/1.jpg') }}"
                    alt="Card image cap">
                <div class="card-body">
        ...
        <div class="col-lg-4 col-md-12 col-12 col-sm-12">
            <div class="card">
                <img class="card-img-top" src="{{ URL::asset('dashboard/assets/img/photos/2.jpg') }}"
                    alt="Card image cap">
                <div class="card-body">
                    <p class="card-text"> To take a trivial example, which of us ever undertakes laborious physical
                        exercise.</p>
        ...
        <div class="col-lg-4 col-md-12 col-12 col-sm-12">
            <div class="card">
                <img class="card-img-top" src="{{ URL::asset('dashboard/assets/img/photos/3.jpg') }}"
                    alt="Card image cap">
                <div class="card-body">
                    <p class="card-text"> To take a trivial example, which of us ever undertakes laborious physical
                        exercise.</p>
    ...
    <div class="row row-sm">
        <div class="col-xl-4 col-lg-4 col-md-12">
            <div class="card">
                <img class="card-img-top w-100" src="{{ URL::asset('dashboard/assets/img/photos/4.jpg') }}"
                    alt="">
                <div class="card-body">
    ...
    <div class="row row-sm">
        <div class="col-xl-4 col-lg-4 col-md-12">
            <div class="card text-center">
                <img class="card-img-top w-100" src="{{ URL::asset('dashboard/assets/img/photos/7.jpg') }}"
                    alt="">
                <div class="card-body">
                    <h4 class="card-title mb-3">Card Title</h4>
                    <p class="card-text">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula
        ...
        <div class="col-xl-4 col-lg-4 col-md-12">
            <div class="card text-center">
                <img class="card-img-top w-100" src="{{ URL::asset('dashboard/assets/img/photos/8.jpg') }}"
                    alt="">
                <div class="card-body">
                    <h4 class="card-title mb-3">Card Title</h4>
                    <p class="card-text">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula
        ...
        <div class="col-xl-4 col-lg-4 col-md-12">
            <div class="card text-center">
                <img class="card-img-top w-100" src="{{ URL::asset('dashboard/assets/img/photos/9.jpg') }}"
                    alt="">
                <div class="card-body">
                    <h4 class="card-title mb-3">Card Title</h4>
                    <p class="card-text">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula
