                        ...
                        <div class="main-chat-contacts" id="chatActiveContacts">
                            <div>
                                <div class="main-img-user online"><img alt=""
                                        src="{{ URL::asset('dashboard/assets/img/faces/3.jpg') }}"></div>
                                <small>Adrian</small>
                            </div>
                            <div>
                                <div class="main-img-user online"><img alt=""
                                        src="{{ URL::asset('dashboard/assets/img/faces/12.jpg') }}"></div>
                                <small>John</small>
                            </div>
                            <div>
                                <div class="main-img-user online"><img alt=""
                                        src="{{ URL::asset('dashboard/assets/img/faces/4.jpg') }}"></div>
                                <small>Daniel</small>
                            </div>
                            <div>
                                <div class="main-img-user online"><img alt=""
                                        src="{{ URL::asset('dashboard/assets/img/faces/13.jpg') }}"></div>
                                <small>Katherine</small>
                            </div>
                            <div>
                                <div class="main-img-user online"><img alt=""
                                        src="{{ URL::asset('dashboard/assets/img/faces/5.jpg') }}"></div>
                                <small>Raymart</small>
                            </div>
                            <div>
                                <div class="main-img-user online"><img alt=""
                                        src="{{ URL::asset('dashboard/assets/img/faces/14.jpg') }}"></div>
                                <small>Junrisk</small>
                            </div>
                            <div>
                                <div class="main-img-user online"><img alt=""
                                        src="{{ URL::asset('dashboard/assets/img/faces/6.jpg') }}"></div>
                                <small>George</small>
                            </div>
                            <div>
                                <div class="main-img-user online"><img alt=""
                                        src="{{ URL::asset('dashboard/assets/img/faces/15.jpg') }}"></div>
                    ...
                    <div class="main-chat-list" id="ChatList">
                        <div class="media new">
                            <div class="main-img-user online">
                                <img alt="" src="{{ URL::asset('dashboard/assets/img/faces/5.jpg') }}">
                                <span>2</span>
                            </div>
                        ...
                        <div class="media new">
                            <div class="main-img-user">
                                <img alt="" src="{{ URL::asset('dashboard/assets/img/faces/6.jpg') }}">
                                <span>1</span>
                            </div>
                            <div class="media-body">
                                <div class="media-contact-name">
                        ...
                        <div class="media selected">
                            <div class="main-img-user online"><img alt=""
                                    src="{{ URL::asset('dashboard/assets/img/faces/9.jpg') }}"></div>
                            <div class="media-body">
                                <div class="media-contact-name">
                        ...
                        <div class="media">
                            <div class="main-img-user"><img alt=""
                                    src="{{ URL::asset('dashboard/assets/img/faces/11.jpg') }}"></div>
                            <div class="media-body">
                                <div class="media-contact-name">
                        ...
                        <div class="media new">
                            <div class="main-img-user">
                                <img alt="" src="{{ URL::asset('dashboard/assets/img/faces/7.jpg') }}">
                                <span>1</span>
                            </div>
                            <div class="media-body">
                                <div class="media-contact-name">
                        ...
                        <div class="media">
                            <div class="main-img-user"><img alt=""
                                    src="{{ URL::asset('dashboard/assets/img/faces/8.jpg') }}"></div>
                            <div class="media-body">
                                <div class="media-contact-name">
                        ...
                        <div class="media">
                            <div class="main-img-user"><img alt=""
                                    src="{{ URL::asset('dashboard/assets/img/faces/10.jpg') }}"></div>
                            <div class="media-body">
                                <div class="media-contact-name">
                        ...
                        <div class="media">
                            <div class="main-img-user"><img alt=""
                                    src="{{ URL::asset('dashboard/assets/img/faces/7.jpg') }}"></div>
                            <div class="media-body">
                                <div class="media-contact-name">
                            ...
                            <div class="media flex-row-reverse">
                                ...
                                <div class="media-body">
                                    ...
                                    <div class="main-msg-wrapper pd-0"><img alt="" class="wd-100 ht-100"
                                            src="{{ URL::asset('dashboard/assets/img/ecommerce/01.jpg') }}"></div>
                                    <div>
